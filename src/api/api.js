...
const url3 = "http://localhost:5000/service"
...
// category
export const postCategory = (categoryData)=> axios.post(`${url}/postCategory`,categoryData)
export const getCategory = ()=> axios.get(`${url}/getCategory`)
export const postService = (serviceData)=> axios.post(`${url3}/postService`,serviceData)
